...
import org.gestion_bibi_hotels.views.ConfirmArrivalPanel;
import org.gestion_bibi_hotels.views.ReservationServicePanel;

import java.util.ArrayList;

/**
 * Controleur gérant la fenêtre du service réservation
 */
public class ReservationServiceController {
    ...
    /**
     * Initialiser la fenêtre de confirmation de l'arrivée d'un client
